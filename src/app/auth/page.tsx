...
export default function AuthPage() {
  ...
  useEffect(() => {
    try {
      ...
      if (v === 'signup' || v === 'login' || v === 'forgot') setAuthView(v as 'login' | 'signup' | 'forgot');
    } catch {}
  }, [setAuthView]);

  return (
    <main className="auth-page" dir={locale === 'fa' ? 'rtl' : 'ltr'}>
  ...
  return (
    <>
      ...
      <form onSubmit={submit} className="auth-form">
        ...
        <button type="button" className="btn btn-social btn-block" onClick={() => (window.location.href = '/api/auth/google')}>
          <span className="gh-icon">
